...
// Resume Modal Functionality with PDF Download
const resumeData = {
    name: "Jayanth U",
    email: "jayanthuppar38@gmail.com",
    phone: "+91 7760834506",
    location: "Shivamogga, Karnataka",
    education: "B.E. in AI & ML (CGPA: 7.05)",
    skills: "Python, ML, NLP, Computer Vision, TensorFlow, PyTorch",
    // UPDATE THIS PATH TO YOUR PDF FILE
    pdfPath: "Jayanth_resume.pdf" // Change this to your actual PDF path
};
...
<div id="resumeModal" class="resume-modal">
    <div class="resume-modal-content">
        ...
        <div class="resume-actions">
            <a href="#" class="modal-btn modal-btn-primary" id="downloadResume">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/>
                </svg>
                Download PDF
            </a>
            <a href="#" class="modal-btn modal-btn-secondary" id="viewResume">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
const resumeNavBtn = document.getElementById('resumeBtn');
...
if (downloadBtn) {
    downloadBtn.addEventListener('click', (e) => {
        ...
        link.download = 'Jayanth_U_Resume.pdf'; // Name for downloaded file
...
if (viewBtn) {
    viewBtn.addEventListener('click', (e) => {
        ...
        // Open PDF in new tab
        window.open(resumeData.pdfPath, '_blank');
    });
}